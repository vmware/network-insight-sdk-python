...
class DellSwitchDataSourceRequest(object):
    ...
    def config_polling_interval_in_min(self):
        """
        Gets the config_polling_interval_in_min of this DellSwitchDataSourceRequest.
        ...
        :return: The config_polling_interval_in_min of this DellSwitchDataSourceRequest.
        :rtype: str
        """
    ...
    def config_polling_interval_in_min(self, config_polling_interval_in_min):
        """
        Sets the config_polling_interval_in_min of this DellSwitchDataSourceRequest.
        Config polling interval to be provided in minutes. Preset values are [10 min, 15 min, 30 min, 1 hour, 12 hours, 1 day, 3 days, 5 days, 7 days]. For any other polling interval, CUSTOM polling interval type should be used. Minimum- 10 minutes, Maximum- 7 days

        :param config_polling_interval_in_min: The config_polling_interval_in_min of this DellSwitchDataSourceRequest.
        :type: str
        """
    ...
    def scheduled_config_polling_time(self):
        """
        Gets the scheduled_config_polling_time of this DellSwitchDataSourceRequest.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :return: The scheduled_config_polling_time of this DellSwitchDataSourceRequest.
        :rtype: str
        """
    ...
    def scheduled_config_polling_time(self, scheduled_config_polling_time):
        """
        Sets the scheduled_config_polling_time of this DellSwitchDataSourceRequest.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_time: The scheduled_config_polling_time of this DellSwitchDataSourceRequest.
        :type: str
        """
    ...
    def scheduled_config_polling_days(self):
        """
        Gets the scheduled_config_polling_days of this DellSwitchDataSourceRequest.
        ...
        :return: The scheduled_config_polling_days of this DellSwitchDataSourceRequest.
        :rtype: str
        """
    ...
    def scheduled_config_polling_days(self, scheduled_config_polling_days):
        """
        Sets the scheduled_config_polling_days of this DellSwitchDataSourceRequest.
        Scheduled config polling days. Supported values are weekdays. Multiple days separated with comma can be supplied. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_days: The scheduled_config_polling_days of this DellSwitchDataSourceRequest.
        :type: str
        """
    ...
    def config_polling_interval_type(self):
        """
        Gets the config_polling_interval_type of this DellSwitchDataSourceRequest.

        :return: The config_polling_interval_type of this DellSwitchDataSourceRequest.
    ...
    def config_polling_interval_type(self, config_polling_interval_type):
        """
        Sets the config_polling_interval_type of this DellSwitchDataSourceRequest.

        :param config_polling_interval_type: The config_polling_interval_type of this DellSwitchDataSourceRequest.
    ...
    def tags(self):
        """
        Gets the tags of this DellSwitchDataSourceRequest.

        :return: The tags of this DellSwitchDataSourceRequest.
        :rtype: list[LocalTag]
        """
        return self._tags
    ...
    def tags(self, tags):
        """
        Sets the tags of this DellSwitchDataSourceRequest.

        :param tags: The tags of this DellSwitchDataSourceRequest.
        :type: list[LocalTag]
        """
    ...
    def enable_ds_associated_tags(self):
        """
        Gets the enable_ds_associated_tags of this DellSwitchDataSourceRequest.

        :return: The enable_ds_associated_tags of this DellSwitchDataSourceRequest.
        :rtype: bool
        """
    ...
    def enable_ds_associated_tags(self, enable_ds_associated_tags):
        """
        Sets the enable_ds_associated_tags of this DellSwitchDataSourceRequest.

        :param enable_ds_associated_tags: The enable_ds_associated_tags of this DellSwitchDataSourceRequest.
        :type: bool
        """
