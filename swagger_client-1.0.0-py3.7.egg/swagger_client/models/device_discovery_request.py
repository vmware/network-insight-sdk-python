...
class DeviceDiscoveryRequest(object):
    ...
    def __init__(self, name=None, network_ranges=None, seeds=None, seed_depth=None, ignored_list=None, credential_profiles=None, proxy_id=None, profile_id=None, ssh_credentials=None, api_credentials=None, snmp_credentials=None, schedule=None):
        """
    ...
    def profile_id(self):
        """
        Gets the profile_id of this DeviceDiscoveryRequest.
        modelKey of discovery profile

        :return: The profile_id of this DeviceDiscoveryRequest.
        :rtype: str
        """
    ...
    def profile_id(self, profile_id):
        """
        Sets the profile_id of this DeviceDiscoveryRequest.
        modelKey of discovery profile

        :param profile_id: The profile_id of this DeviceDiscoveryRequest.
        :type: str
        """
    ...
    def ssh_credentials(self):
        """
        Gets the ssh_credentials of this DeviceDiscoveryRequest.
        List of SSH Credentials.

        :return: The ssh_credentials of this DeviceDiscoveryRequest.
    ...
    def ssh_credentials(self, ssh_credentials):
        """
        Sets the ssh_credentials of this DeviceDiscoveryRequest.
        List of SSH Credentials.

        :param ssh_credentials: The ssh_credentials of this DeviceDiscoveryRequest.
    ...
    def api_credentials(self):
        """
        Gets the api_credentials of this DeviceDiscoveryRequest.
        List of API Credentials.

        :return: The api_credentials of this DeviceDiscoveryRequest.
    ...
    def api_credentials(self, api_credentials):
        """
        Sets the api_credentials of this DeviceDiscoveryRequest.
        List of API Credentials.

        :param api_credentials: The api_credentials of this DeviceDiscoveryRequest.
    ...
    def snmp_credentials(self):
        """
        Gets the snmp_credentials of this DeviceDiscoveryRequest.
        List of SNMP Credentials.

        :return: The snmp_credentials of this DeviceDiscoveryRequest.
    ...
    def snmp_credentials(self, snmp_credentials):
        """
        Sets the snmp_credentials of this DeviceDiscoveryRequest.
        List of SNMP Credentials.

        :param snmp_credentials: The snmp_credentials of this DeviceDiscoveryRequest.
    ...
    def schedule(self):
        """
        Gets the schedule of this DeviceDiscoveryRequest.

        :return: The schedule of this DeviceDiscoveryRequest.
        :rtype: Schedule
        """
    ...
    def schedule(self, schedule):
        """
        Sets the schedule of this DeviceDiscoveryRequest.

        :param schedule: The schedule of this DeviceDiscoveryRequest.
        :type: Schedule
        """
