...
class ShareCustomDashboardRequest(object):
    """
    ...
    def __init__(self, users_read_access=None, users_write_access=None, groups_read_access=None, groups_write_access=None):
        """
        ShareCustomDashboardRequest - a model defined in Swagger
        """
    ...
    def users_read_access(self):
        """
        Gets the users_read_access of this ShareCustomDashboardRequest.
        List of users with read privilege for the custom dashboard

        :return: The users_read_access of this ShareCustomDashboardRequest.
        :rtype: list[str]
        """
    ...
    def users_read_access(self, users_read_access):
        """
        Sets the users_read_access of this ShareCustomDashboardRequest.
        List of users with read privilege for the custom dashboard

        :param users_read_access: The users_read_access of this ShareCustomDashboardRequest.
        :type: list[str]
        """
    ...
    def users_write_access(self):
        """
        Gets the users_write_access of this ShareCustomDashboardRequest.
        List of users with all privileges for the custom dashboard

        :return: The users_write_access of this ShareCustomDashboardRequest.
        :rtype: list[str]
        """
    ...
    def users_write_access(self, users_write_access):
        """
        Sets the users_write_access of this ShareCustomDashboardRequest.
        List of users with all privileges for the custom dashboard

        :param users_write_access: The users_write_access of this ShareCustomDashboardRequest.
        :type: list[str]
        """
    ...
    def groups_read_access(self):
        """
        Gets the groups_read_access of this ShareCustomDashboardRequest.
        List of groups with read privilege for the custom dashboard

        :return: The groups_read_access of this ShareCustomDashboardRequest.
        :rtype: list[str]
        """
    ...
    def groups_read_access(self, groups_read_access):
        """
        Sets the groups_read_access of this ShareCustomDashboardRequest.
        List of groups with read privilege for the custom dashboard

        :param groups_read_access: The groups_read_access of this ShareCustomDashboardRequest.
        :type: list[str]
        """
    ...
    def groups_write_access(self):
        """
        Gets the groups_write_access of this ShareCustomDashboardRequest.
        List of groups with read and write privilege for the custom dashboard

        :return: The groups_write_access of this ShareCustomDashboardRequest.
        :rtype: list[str]
        """
    ...
    def groups_write_access(self, groups_write_access):
        """
        Sets the groups_write_access of this ShareCustomDashboardRequest.
        List of groups with read and write privilege for the custom dashboard

        :param groups_write_access: The groups_write_access of this ShareCustomDashboardRequest.
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ShareCustomDashboardRequest):
            return False
