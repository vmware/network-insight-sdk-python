...
class PanFirewallDataSourceRequest(object):
    ...
    def config_polling_interval_in_min(self):
        """
        Gets the config_polling_interval_in_min of this PanFirewallDataSourceRequest.
        ...
        :return: The config_polling_interval_in_min of this PanFirewallDataSourceRequest.
        :rtype: str
        """
    ...
    def config_polling_interval_in_min(self, config_polling_interval_in_min):
        """
        Sets the config_polling_interval_in_min of this PanFirewallDataSourceRequest.
        Config polling interval to be provided in minutes. Preset values are [10 min, 15 min, 30 min, 1 hour, 12 hours, 1 day, 3 days, 5 days, 7 days]. For any other polling interval, CUSTOM polling interval type should be used. Minimum- 10 minutes, Maximum- 7 days

        :param config_polling_interval_in_min: The config_polling_interval_in_min of this PanFirewallDataSourceRequest.
        :type: str
        """
    ...
    def scheduled_config_polling_time(self):
        """
        Gets the scheduled_config_polling_time of this PanFirewallDataSourceRequest.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :return: The scheduled_config_polling_time of this PanFirewallDataSourceRequest.
        :rtype: str
        """
    ...
    def scheduled_config_polling_time(self, scheduled_config_polling_time):
        """
        Sets the scheduled_config_polling_time of this PanFirewallDataSourceRequest.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_time: The scheduled_config_polling_time of this PanFirewallDataSourceRequest.
        :type: str
        """
    ...
    def scheduled_config_polling_days(self):
        """
        Gets the scheduled_config_polling_days of this PanFirewallDataSourceRequest.
        ...
        :return: The scheduled_config_polling_days of this PanFirewallDataSourceRequest.
        :rtype: str
        """
    ...
    def scheduled_config_polling_days(self, scheduled_config_polling_days):
        """
        Sets the scheduled_config_polling_days of this PanFirewallDataSourceRequest.
        Scheduled config polling days. Supported values are weekdays. Multiple days separated with comma can be supplied. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_days: The scheduled_config_polling_days of this PanFirewallDataSourceRequest.
        :type: str
        """
    ...
    def config_polling_interval_type(self):
        """
        Gets the config_polling_interval_type of this PanFirewallDataSourceRequest.

        :return: The config_polling_interval_type of this PanFirewallDataSourceRequest.
    ...
    def config_polling_interval_type(self, config_polling_interval_type):
        """
        Sets the config_polling_interval_type of this PanFirewallDataSourceRequest.

        :param config_polling_interval_type: The config_polling_interval_type of this PanFirewallDataSourceRequest.
    ...
    def tags(self):
        """
        Gets the tags of this PanFirewallDataSourceRequest.

        :return: The tags of this PanFirewallDataSourceRequest.
        :rtype: list[LocalTag]
        """
        return self._tags
    ...
    def tags(self, tags):
        """
        Sets the tags of this PanFirewallDataSourceRequest.

        :param tags: The tags of this PanFirewallDataSourceRequest.
        :type: list[LocalTag]
        """
    ...
    def enable_ds_associated_tags(self):
        """
        Gets the enable_ds_associated_tags of this PanFirewallDataSourceRequest.

        :return: The enable_ds_associated_tags of this PanFirewallDataSourceRequest.
        :rtype: bool
        """
    ...
    def enable_ds_associated_tags(self, enable_ds_associated_tags):
        """
        Sets the enable_ds_associated_tags of this PanFirewallDataSourceRequest.

        :param enable_ds_associated_tags: The enable_ds_associated_tags of this PanFirewallDataSourceRequest.
        :type: bool
        """
