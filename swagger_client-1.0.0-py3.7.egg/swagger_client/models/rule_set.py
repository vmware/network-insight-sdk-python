...
class RuleSet(object):
    ...
    def rule_set_type(self, rule_set_type):
        ...
        :type: str
        """
        allowed_values = ["NSX_STANDARD", "NSX_REDIRECT", "AWS_STANDARD", "NSXT_EDGE_FIREWALL", "ACCESS_RULE", "DEFAULT_TYPE", "POLICYMANAGER_EMERGENCY_TYPE", "POLICYMANAGER_INFRASTRUCTURE_TYPE", "POLICYMANAGER_ENVIRONMENT_TYPE", "POLICYMANAGER_APPLICATION_TYPE", "POLICYMANAGER_ETHERNET_TYPE"]
