...
class FBADConfigResponse(object):
    """
    ...
    def __init__(self, scope_object_type=0, scope_entities=None, full_fetch_flow_interval_in_sec=0, pause_discovery=False, application_naming_preferences=None, tier_naming_preferences=None, discovery_options=None, id=None):
        """
        FBADConfigResponse - a model defined in Swagger
        """
    ...
    def scope_object_type(self):
        """
        Gets the scope_object_type of this FBADConfigResponse.
        The type of objects in the scope entities

        :return: The scope_object_type of this FBADConfigResponse.
        :rtype: int
        """
    ...
    def scope_object_type(self, scope_object_type):
        """
        Sets the scope_object_type of this FBADConfigResponse.
        The type of objects in the scope entities

        :param scope_object_type: The scope_object_type of this FBADConfigResponse.
        :type: int
        """
    ...
    def scope_entities(self):
        """
        Gets the scope_entities of this FBADConfigResponse.
        The list of name of the entities to be considered in discovery scope

        :return: The scope_entities of this FBADConfigResponse.
        :rtype: list[str]
        """
    ...
    def scope_entities(self, scope_entities):
        """
        Sets the scope_entities of this FBADConfigResponse.
        The list of name of the entities to be considered in discovery scope

        :param scope_entities: The scope_entities of this FBADConfigResponse.
        :type: list[str]
        """
    ...
    def full_fetch_flow_interval_in_sec(self):
        """
        Gets the full_fetch_flow_interval_in_sec of this FBADConfigResponse.
        ...
        :return: The full_fetch_flow_interval_in_sec of this FBADConfigResponse.
        :rtype: int
        """
    ...
    def full_fetch_flow_interval_in_sec(self, full_fetch_flow_interval_in_sec):
        """
        Sets the full_fetch_flow_interval_in_sec of this FBADConfigResponse.
        Full fetch flow interval in seconds. Range of allowed values is number of seconds in one week to number of seconds in one month, both values included.

        :param full_fetch_flow_interval_in_sec: The full_fetch_flow_interval_in_sec of this FBADConfigResponse.
        :type: int
        """
    ...
    def pause_discovery(self, pause_discovery):
        """
        Sets the pause_discovery of this FBADConfigResponse.
        True means pause the application and tier discovery and false means resume flow based application and tier discovery

        :param pause_discovery: The pause_discovery of this FBADConfigResponse.
        :type: bool
        """
    ...
    def application_naming_preferences(self):
        """
        Gets the application_naming_preferences of this FBADConfigResponse.
        ...
        :return: The application_naming_preferences of this FBADConfigResponse.
    ...
    def application_naming_preferences(self, application_naming_preferences):
        """
        Sets the application_naming_preferences of this FBADConfigResponse.
        List of application naming preferences. The order should be the same as tier naming preferences. VM Names preference will be added to the end of the naming preferences if not present already.

        :param application_naming_preferences: The application_naming_preferences of this FBADConfigResponse.
    ...
    def tier_naming_preferences(self):
        """
        Gets the tier_naming_preferences of this FBADConfigResponse.
        ...
        :return: The tier_naming_preferences of this FBADConfigResponse.
        :rtype: list[NamingPreference]
        """
    ...
    def tier_naming_preferences(self, tier_naming_preferences):
        """
        Sets the tier_naming_preferences of this FBADConfigResponse.
        List of tier naming preferences. The order should be the same as application naming preferences. VM Names preference will be added to the end of the naming preferences if not present already.

        :param tier_naming_preferences: The tier_naming_preferences of this FBADConfigResponse.
        :type: list[NamingPreference]
        """
    ...
    def discovery_options(self):
        """
        Gets the discovery_options of this FBADConfigResponse.
        ...
        :return: The discovery_options of this FBADConfigResponse.
    ...
    def discovery_options(self, discovery_options):
        """
        Sets the discovery_options of this FBADConfigResponse.
        The ordered list of preferences to be used for discovery of applications and tiers to improve flow based application discovery. Add CSV enrichment preference to use the uploaded CSV in improving discovery. LB enrichment preference will be added at the end of the list if not present already.

        :param discovery_options: The discovery_options of this FBADConfigResponse.
    ...
    def id(self):
        """
        Gets the id of this FBADConfigResponse.
        The id of discovery config

        :return: The id of this FBADConfigResponse.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this FBADConfigResponse.
        The id of discovery config

        :param id: The id of this FBADConfigResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, FBADConfigResponse):
            return False
