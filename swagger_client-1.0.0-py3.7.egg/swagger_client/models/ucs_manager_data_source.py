...
class UCSManagerDataSource(object):
    """
    ...
    def __init__(self, entity_id=None, entity_type=None, ip=None, fqdn=None, proxy_id=None, nickname=None, enabled=True, notes=None, certificate=None, sha_thumbprint=None, new_certificate=None, new_sha_thumbprint=None, config_polling_interval_in_min=None, scheduled_config_polling_time=None, scheduled_config_polling_days=None, config_polling_interval_type=None, credentials=None, tags=None, enable_ds_associated_tags=None):
        """
        UCSManagerDataSource - a model defined in Swagger
        """
    ...
    def certificate(self):
        """
        Gets the certificate of this UCSManagerDataSource.
        Certificate of data source

        :return: The certificate of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def certificate(self, certificate):
        """
        Sets the certificate of this UCSManagerDataSource.
        Certificate of data source

        :param certificate: The certificate of this UCSManagerDataSource.
        :type: str
        """
    ...
    def sha_thumbprint(self):
        """
        Gets the sha_thumbprint of this UCSManagerDataSource.
        SHA thumbprint of data source

        :return: The sha_thumbprint of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def sha_thumbprint(self, sha_thumbprint):
        """
        Sets the sha_thumbprint of this UCSManagerDataSource.
        SHA thumbprint of data source

        :param sha_thumbprint: The sha_thumbprint of this UCSManagerDataSource.
        :type: str
        """
    ...
    def new_certificate(self):
        """
        Gets the new_certificate of this UCSManagerDataSource.
        New certificate of data source

        :return: The new_certificate of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def new_certificate(self, new_certificate):
        """
        Sets the new_certificate of this UCSManagerDataSource.
        New certificate of data source

        :param new_certificate: The new_certificate of this UCSManagerDataSource.
        :type: str
        """
    ...
    def new_sha_thumbprint(self):
        """
        Gets the new_sha_thumbprint of this UCSManagerDataSource.
        New SHA thumbprint of data source

        :return: The new_sha_thumbprint of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def new_sha_thumbprint(self, new_sha_thumbprint):
        """
        Sets the new_sha_thumbprint of this UCSManagerDataSource.
        New SHA thumbprint of data source

        :param new_sha_thumbprint: The new_sha_thumbprint of this UCSManagerDataSource.
        :type: str
        """
    ...
    def config_polling_interval_in_min(self):
        """
        Gets the config_polling_interval_in_min of this UCSManagerDataSource.
        ...
        :return: The config_polling_interval_in_min of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def config_polling_interval_in_min(self, config_polling_interval_in_min):
        """
        Sets the config_polling_interval_in_min of this UCSManagerDataSource.
        Config polling interval to be provided in minutes. Preset values are [10 min, 15 min, 30 min, 1 hour, 12 hours, 1 day, 3 days, 5 days, 7 days]. For any other polling interval, CUSTOM polling interval type should be used. Minimum- 10 minutes, Maximum- 7 days

        :param config_polling_interval_in_min: The config_polling_interval_in_min of this UCSManagerDataSource.
        :type: str
        """
    ...
    def scheduled_config_polling_time(self):
        """
        Gets the scheduled_config_polling_time of this UCSManagerDataSource.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :return: The scheduled_config_polling_time of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def scheduled_config_polling_time(self, scheduled_config_polling_time):
        """
        Sets the scheduled_config_polling_time of this UCSManagerDataSource.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_time: The scheduled_config_polling_time of this UCSManagerDataSource.
        :type: str
        """
    ...
    def scheduled_config_polling_days(self):
        """
        Gets the scheduled_config_polling_days of this UCSManagerDataSource.
        ...
        :return: The scheduled_config_polling_days of this UCSManagerDataSource.
        :rtype: str
        """
    ...
    def scheduled_config_polling_days(self, scheduled_config_polling_days):
        """
        Sets the scheduled_config_polling_days of this UCSManagerDataSource.
        Scheduled config polling days. Supported values are weekdays. Multiple days separated with comma can be supplied. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_days: The scheduled_config_polling_days of this UCSManagerDataSource.
        :type: str
        """
    ...
    def config_polling_interval_type(self):
        """
        Gets the config_polling_interval_type of this UCSManagerDataSource.

        :return: The config_polling_interval_type of this UCSManagerDataSource.
    ...
    def config_polling_interval_type(self, config_polling_interval_type):
        """
        Sets the config_polling_interval_type of this UCSManagerDataSource.

        :param config_polling_interval_type: The config_polling_interval_type of this UCSManagerDataSource.
    ...
    def tags(self):
        """
        Gets the tags of this UCSManagerDataSource.

        :return: The tags of this UCSManagerDataSource.
        :rtype: list[LocalTag]
        """
        return self._tags
    ...
    def tags(self, tags):
        """
        Sets the tags of this UCSManagerDataSource.

        :param tags: The tags of this UCSManagerDataSource.
        :type: list[LocalTag]
        """
    ...
    def enable_ds_associated_tags(self):
        """
        Gets the enable_ds_associated_tags of this UCSManagerDataSource.

        :return: The enable_ds_associated_tags of this UCSManagerDataSource.
        :rtype: bool
        """
    ...
    def enable_ds_associated_tags(self, enable_ds_associated_tags):
        """
        Sets the enable_ds_associated_tags of this UCSManagerDataSource.

        :param enable_ds_associated_tags: The enable_ds_associated_tags of this UCSManagerDataSource.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UCSManagerDataSource):
            return False
