...
class EC2Instance(object):
    ...
    def default_gateways(self):
        """
        Gets the default_gateways of this EC2Instance.
        Default gateways of the VM

        :return: The default_gateways of this EC2Instance.
        :rtype: list[str]
        """
    ...
    def default_gateways(self, default_gateways):
        """
        Sets the default_gateways of this EC2Instance.
        Default gateways of the VM

        :param default_gateways: The default_gateways of this EC2Instance.
        :type: list[str]
        """
    ...
    def tag_keys(self):
        """
        Gets the tag_keys of this EC2Instance.

        :return: The tag_keys of this EC2Instance.
        :rtype: list[str]
        """
    ...
    def tag_keys(self, tag_keys):
        """
        Sets the tag_keys of this EC2Instance.

        :param tag_keys: The tag_keys of this EC2Instance.
        :type: list[str]
        """
    ...
    def tag_key_values(self):
        """
        Gets the tag_key_values of this EC2Instance.

        :return: The tag_key_values of this EC2Instance.
        :rtype: list[str]
        """
    ...
    def tag_key_values(self, tag_key_values):
        """
        Sets the tag_key_values of this EC2Instance.

        :param tag_key_values: The tag_key_values of this EC2Instance.
        :type: list[str]
        """
    ...
    def tag_values(self):
        """
        Gets the tag_values of this EC2Instance.

        :return: The tag_values of this EC2Instance.
        :rtype: list[str]
        """
    ...
    def tag_values(self, tag_values):
        """
        Sets the tag_values of this EC2Instance.

        :param tag_values: The tag_values of this EC2Instance.
        :type: list[str]
        """
    ...
    def vm_uuid(self):
        """
        Gets the vm_uuid of this EC2Instance.
        UUID of the VM

        :return: The vm_uuid of this EC2Instance.
        :rtype: str
        """
    ...
    def vm_uuid(self, vm_uuid):
        """
        Sets the vm_uuid of this EC2Instance.
        UUID of the VM

        :param vm_uuid: The vm_uuid of this EC2Instance.
        :type: str
        """
    ...
    def manager_uuid(self):
        """
        Gets the manager_uuid of this EC2Instance.
        UUID of the Manager

        :return: The manager_uuid of this EC2Instance.
        :rtype: str
        """
    ...
    def manager_uuid(self, manager_uuid):
        """
        Sets the manager_uuid of this EC2Instance.
        UUID of the Manager

        :param manager_uuid: The manager_uuid of this EC2Instance.
        :type: str
        """
