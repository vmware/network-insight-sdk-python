...
class DellSwitchDataSource(object):
    """
    ...
    def __init__(self, entity_id=None, entity_type=None, ip=None, fqdn=None, proxy_id=None, nickname=None, enabled=True, notes=None, certificate=None, sha_thumbprint=None, new_certificate=None, new_sha_thumbprint=None, config_polling_interval_in_min=None, scheduled_config_polling_time=None, scheduled_config_polling_days=None, config_polling_interval_type=None, credentials=None, tags=None, enable_ds_associated_tags=None, switch_type=None):
        """
        DellSwitchDataSource - a model defined in Swagger
        """
    ...
    def certificate(self):
        """
        Gets the certificate of this DellSwitchDataSource.
        Certificate of data source

        :return: The certificate of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def certificate(self, certificate):
        """
        Sets the certificate of this DellSwitchDataSource.
        Certificate of data source

        :param certificate: The certificate of this DellSwitchDataSource.
        :type: str
        """
    ...
    def sha_thumbprint(self):
        """
        Gets the sha_thumbprint of this DellSwitchDataSource.
        SHA thumbprint of data source

        :return: The sha_thumbprint of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def sha_thumbprint(self, sha_thumbprint):
        """
        Sets the sha_thumbprint of this DellSwitchDataSource.
        SHA thumbprint of data source

        :param sha_thumbprint: The sha_thumbprint of this DellSwitchDataSource.
        :type: str
        """
    ...
    def new_certificate(self):
        """
        Gets the new_certificate of this DellSwitchDataSource.
        New certificate of data source

        :return: The new_certificate of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def new_certificate(self, new_certificate):
        """
        Sets the new_certificate of this DellSwitchDataSource.
        New certificate of data source

        :param new_certificate: The new_certificate of this DellSwitchDataSource.
        :type: str
        """
    ...
    def new_sha_thumbprint(self):
        """
        Gets the new_sha_thumbprint of this DellSwitchDataSource.
        New SHA thumbprint of data source

        :return: The new_sha_thumbprint of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def new_sha_thumbprint(self, new_sha_thumbprint):
        """
        Sets the new_sha_thumbprint of this DellSwitchDataSource.
        New SHA thumbprint of data source

        :param new_sha_thumbprint: The new_sha_thumbprint of this DellSwitchDataSource.
        :type: str
        """
    ...
    def config_polling_interval_in_min(self):
        """
        Gets the config_polling_interval_in_min of this DellSwitchDataSource.
        ...
        :return: The config_polling_interval_in_min of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def config_polling_interval_in_min(self, config_polling_interval_in_min):
        """
        Sets the config_polling_interval_in_min of this DellSwitchDataSource.
        Config polling interval to be provided in minutes. Preset values are [10 min, 15 min, 30 min, 1 hour, 12 hours, 1 day, 3 days, 5 days, 7 days]. For any other polling interval, CUSTOM polling interval type should be used. Minimum- 10 minutes, Maximum- 7 days

        :param config_polling_interval_in_min: The config_polling_interval_in_min of this DellSwitchDataSource.
        :type: str
        """
    ...
    def scheduled_config_polling_time(self):
        """
        Gets the scheduled_config_polling_time of this DellSwitchDataSource.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :return: The scheduled_config_polling_time of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def scheduled_config_polling_time(self, scheduled_config_polling_time):
        """
        Sets the scheduled_config_polling_time of this DellSwitchDataSource.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_time: The scheduled_config_polling_time of this DellSwitchDataSource.
        :type: str
        """
    ...
    def scheduled_config_polling_days(self):
        """
        Gets the scheduled_config_polling_days of this DellSwitchDataSource.
        ...
        :return: The scheduled_config_polling_days of this DellSwitchDataSource.
        :rtype: str
        """
    ...
    def scheduled_config_polling_days(self, scheduled_config_polling_days):
        """
        Sets the scheduled_config_polling_days of this DellSwitchDataSource.
        Scheduled config polling days. Supported values are weekdays. Multiple days separated with comma can be supplied. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_days: The scheduled_config_polling_days of this DellSwitchDataSource.
        :type: str
        """
    ...
    def config_polling_interval_type(self):
        """
        Gets the config_polling_interval_type of this DellSwitchDataSource.

        :return: The config_polling_interval_type of this DellSwitchDataSource.
    ...
    def config_polling_interval_type(self, config_polling_interval_type):
        """
        Sets the config_polling_interval_type of this DellSwitchDataSource.

        :param config_polling_interval_type: The config_polling_interval_type of this DellSwitchDataSource.
    ...
    def tags(self):
        """
        Gets the tags of this DellSwitchDataSource.

        :return: The tags of this DellSwitchDataSource.
        :rtype: list[LocalTag]
        """
        return self._tags
    ...
    def tags(self, tags):
        """
        Sets the tags of this DellSwitchDataSource.

        :param tags: The tags of this DellSwitchDataSource.
        :type: list[LocalTag]
        """
    ...
    def enable_ds_associated_tags(self):
        """
        Gets the enable_ds_associated_tags of this DellSwitchDataSource.

        :return: The enable_ds_associated_tags of this DellSwitchDataSource.
        :rtype: bool
        """
    ...
    def enable_ds_associated_tags(self, enable_ds_associated_tags):
        """
        Sets the enable_ds_associated_tags of this DellSwitchDataSource.

        :param enable_ds_associated_tags: The enable_ds_associated_tags of this DellSwitchDataSource.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DellSwitchDataSource):
            return False
