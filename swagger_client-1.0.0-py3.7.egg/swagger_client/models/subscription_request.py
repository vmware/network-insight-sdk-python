...
class SubscriptionRequest(object):
    ...
    def __init__(self, event_name=None, is_problem=None, severity=None, search_criteria=None, generate_event_criteria=None, email_frequency=None, daily_at_utc=None, email_ids=None, snmp_trap_entity_ids=None, notification_settings=None):
        """
    ...
    def notification_settings(self):
        """
        Gets the notification_settings of this SubscriptionRequest.
        Notifications configured for alerts corresponding to this alert configuration.

        :return: The notification_settings of this SubscriptionRequest.
    ...
    def notification_settings(self, notification_settings):
        """
        Sets the notification_settings of this SubscriptionRequest.
        Notifications configured for alerts corresponding to this alert configuration.

        :param notification_settings: The notification_settings of this SubscriptionRequest.
