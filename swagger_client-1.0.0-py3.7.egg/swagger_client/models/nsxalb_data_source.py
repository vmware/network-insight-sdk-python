...
class NSXALBDataSource(object):
    ...
    def __init__(self, entity_id=None, entity_type=None, ip=None, fqdn=None, proxy_id=None, nickname=None, enabled=True, notes=None, certificate=None, sha_thumbprint=None, new_certificate=None, new_sha_thumbprint=None, config_polling_interval_in_min=None, scheduled_config_polling_time=None, scheduled_config_polling_days=None, config_polling_interval_type=None, credentials=None, tags=None, enable_ds_associated_tags=None):
        """
        NSXALBDataSource - a model defined in Swagger
        """
    ...
    def entity_id(self):
        """
        Gets the entity_id of this NSXALBDataSource.
        Internal ID of data source, to be used in subsequent API calls

        :return: The entity_id of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def entity_id(self, entity_id):
        """
        Sets the entity_id of this NSXALBDataSource.
        Internal ID of data source, to be used in subsequent API calls

        :param entity_id: The entity_id of this NSXALBDataSource.
        :type: str
        """
    ...
    def entity_type(self):
        """
        Gets the entity_type of this NSXALBDataSource.

        :return: The entity_type of this NSXALBDataSource.
    ...
    def entity_type(self, entity_type):
        """
        Sets the entity_type of this NSXALBDataSource.

        :param entity_type: The entity_type of this NSXALBDataSource.
        :type: DataSourceType
        """
    ...
    def ip(self):
        """
        Gets the ip of this NSXALBDataSource.
        IP address of data source (use either IP or FQDN, not both)

        :return: The ip of this NSXALBDataSource.
        :rtype: str
        """
        return self._ip
    ...
    def ip(self, ip):
        """
        Sets the ip of this NSXALBDataSource.
        IP address of data source (use either IP or FQDN, not both)

        :param ip: The ip of this NSXALBDataSource.
        :type: str
        """
    ...
    def fqdn(self):
        """
        Gets the fqdn of this NSXALBDataSource.
        Hostname of data source (use either IP or FQDN, not both)

        :return: The fqdn of this NSXALBDataSource.
        :rtype: str
        """
        return self._fqdn
    ...
    def fqdn(self, fqdn):
        """
        Sets the fqdn of this NSXALBDataSource.
        Hostname of data source (use either IP or FQDN, not both)

        :param fqdn: The fqdn of this NSXALBDataSource.
        :type: str
        """
    ...
    def proxy_id(self):
        """
        Gets the proxy_id of this NSXALBDataSource.
        ID of Collector VM which should register this vcenter

        :return: The proxy_id of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def proxy_id(self, proxy_id):
        """
        Sets the proxy_id of this NSXALBDataSource.
        ID of Collector VM which should register this vcenter

        :param proxy_id: The proxy_id of this NSXALBDataSource.
        :type: str
        """
    ...
    def nickname(self):
        """
        Gets the nickname of this NSXALBDataSource.
        A friendly nickname for the data source

        :return: The nickname of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def nickname(self, nickname):
        """
        Sets the nickname of this NSXALBDataSource.
        A friendly nickname for the data source

        :param nickname: The nickname of this NSXALBDataSource.
        :type: str
        """
    ...
    def enabled(self):
        """
        Gets the enabled of this NSXALBDataSource.
        Whether or not data collection is enabled

        :return: The enabled of this NSXALBDataSource.
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """
        Sets the enabled of this NSXALBDataSource.
        Whether or not data collection is enabled

        :param enabled: The enabled of this NSXALBDataSource.
        :type: bool
        """
    ...
    def notes(self):
        """
        Gets the notes of this NSXALBDataSource.
        Room for notes or comments about the data source

        :return: The notes of this NSXALBDataSource.
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """
        Sets the notes of this NSXALBDataSource.
        Room for notes or comments about the data source

        :param notes: The notes of this NSXALBDataSource.
        :type: str
        """
    ...
    def certificate(self):
        """
        Gets the certificate of this NSXALBDataSource.
        Certificate of data source

        :return: The certificate of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def certificate(self, certificate):
        """
        Sets the certificate of this NSXALBDataSource.
        Certificate of data source

        :param certificate: The certificate of this NSXALBDataSource.
        :type: str
        """
    ...
    def sha_thumbprint(self):
        """
        Gets the sha_thumbprint of this NSXALBDataSource.
        SHA thumbprint of data source

        :return: The sha_thumbprint of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def sha_thumbprint(self, sha_thumbprint):
        """
        Sets the sha_thumbprint of this NSXALBDataSource.
        SHA thumbprint of data source

        :param sha_thumbprint: The sha_thumbprint of this NSXALBDataSource.
        :type: str
        """
    ...
    def new_certificate(self):
        """
        Gets the new_certificate of this NSXALBDataSource.
        New certificate of data source

        :return: The new_certificate of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def new_certificate(self, new_certificate):
        """
        Sets the new_certificate of this NSXALBDataSource.
        New certificate of data source

        :param new_certificate: The new_certificate of this NSXALBDataSource.
        :type: str
        """
    ...
    def new_sha_thumbprint(self):
        """
        Gets the new_sha_thumbprint of this NSXALBDataSource.
        New SHA thumbprint of data source

        :return: The new_sha_thumbprint of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def new_sha_thumbprint(self, new_sha_thumbprint):
        """
        Sets the new_sha_thumbprint of this NSXALBDataSource.
        New SHA thumbprint of data source

        :param new_sha_thumbprint: The new_sha_thumbprint of this NSXALBDataSource.
        :type: str
        """
    ...
    def config_polling_interval_in_min(self):
        """
        Gets the config_polling_interval_in_min of this NSXALBDataSource.
        ...
        :return: The config_polling_interval_in_min of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def config_polling_interval_in_min(self, config_polling_interval_in_min):
        """
        Sets the config_polling_interval_in_min of this NSXALBDataSource.
        Config polling interval to be provided in minutes. Preset values are [10 min, 15 min, 30 min, 1 hour, 12 hours, 1 day, 3 days, 5 days, 7 days]. For any other polling interval, CUSTOM polling interval type should be used. Minimum- 10 minutes, Maximum- 7 days

        :param config_polling_interval_in_min: The config_polling_interval_in_min of this NSXALBDataSource.
        :type: str
        """
    ...
    def scheduled_config_polling_time(self):
        """
        Gets the scheduled_config_polling_time of this NSXALBDataSource.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :return: The scheduled_config_polling_time of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def scheduled_config_polling_time(self, scheduled_config_polling_time):
        """
        Sets the scheduled_config_polling_time of this NSXALBDataSource.
        Scheduled time (UTC) to be provided. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_time: The scheduled_config_polling_time of this NSXALBDataSource.
        :type: str
        """
    ...
    def scheduled_config_polling_days(self):
        """
        Gets the scheduled_config_polling_days of this NSXALBDataSource.
        ...
        :return: The scheduled_config_polling_days of this NSXALBDataSource.
        :rtype: str
        """
    ...
    def scheduled_config_polling_days(self, scheduled_config_polling_days):
        """
        Sets the scheduled_config_polling_days of this NSXALBDataSource.
        Scheduled config polling days. Supported values are weekdays. Multiple days separated with comma can be supplied. This is only applicable when config_polling_interval_type is SCHEDULED

        :param scheduled_config_polling_days: The scheduled_config_polling_days of this NSXALBDataSource.
        :type: str
        """
    ...
    def config_polling_interval_type(self):
        """
        Gets the config_polling_interval_type of this NSXALBDataSource.

        :return: The config_polling_interval_type of this NSXALBDataSource.
    ...
    def config_polling_interval_type(self, config_polling_interval_type):
        """
        Sets the config_polling_interval_type of this NSXALBDataSource.

        :param config_polling_interval_type: The config_polling_interval_type of this NSXALBDataSource.
    ...
    def credentials(self):
        """
        Gets the credentials of this NSXALBDataSource.

        :return: The credentials of this NSXALBDataSource.
    ...
    def credentials(self, credentials):
        """
        Sets the credentials of this NSXALBDataSource.

        :param credentials: The credentials of this NSXALBDataSource.
    ...
    def tags(self):
        """
        Gets the tags of this NSXALBDataSource.

        :return: The tags of this NSXALBDataSource.
        :rtype: list[LocalTag]
        """
        return self._tags
    ...
    def tags(self, tags):
        """
        Sets the tags of this NSXALBDataSource.

        :param tags: The tags of this NSXALBDataSource.
        :type: list[LocalTag]
        """
    ...
    def enable_ds_associated_tags(self):
        """
        Gets the enable_ds_associated_tags of this NSXALBDataSource.

        :return: The enable_ds_associated_tags of this NSXALBDataSource.
        :rtype: bool
        """
    ...
    def enable_ds_associated_tags(self, enable_ds_associated_tags):
        """
        Sets the enable_ds_associated_tags of this NSXALBDataSource.

        :param enable_ds_associated_tags: The enable_ds_associated_tags of this NSXALBDataSource.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NSXALBDataSource):
            return False
