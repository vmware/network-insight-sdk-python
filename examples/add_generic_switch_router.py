...
# To add generic router/switch vRealize Network Insight Data Sources for currently unsupported switch/router.
...
def get_add_request_body(args, proxy_id):
    api_request_body = {"proxy_id": "{}".format(proxy_id),
                        ...
                        "entity_type": "UANICiscoDataSource",
                        "notes": "generic_device_{}".format(args.device_ip),
...
def parse_arguments():
    ...
    parser.add_argument('--device_ip', action='store', help='switch or router IP', required=True)
    ...
    parser.add_argument("--zip_file_path", action="store",
                        default='/home/ubuntu/abc_switch.zip', help="zip file generated by uani")
