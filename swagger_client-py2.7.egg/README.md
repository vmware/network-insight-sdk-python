...
*DataSourcesApi* | [**add_hcx_datasource**](docs/DataSourcesApi.md#add_hcx_datasource) | **POST** /data-sources/hcxs | Create an hcx data source
...
*DataSourcesApi* | [**delete_hcx**](docs/DataSourcesApi.md#delete_hcx) | **DELETE** /data-sources/hcxs/{id} | Delete an hcx data source
...
*DataSourcesApi* | [**disable_hcx**](docs/DataSourcesApi.md#disable_hcx) | **POST** /data-sources/hcxs/{id}/disable | Disable an hcx data source
...
*DataSourcesApi* | [**enable_hcx**](docs/DataSourcesApi.md#enable_hcx) | **POST** /data-sources/hcxs/{id}/enable | Enable an hcx data source
...
*DataSourcesApi* | [**get_hcx**](docs/DataSourcesApi.md#get_hcx) | **GET** /data-sources/hcxs/{id} | Show hcx data source details
...
*DataSourcesApi* | [**list_hcxs**](docs/DataSourcesApi.md#list_hcxs) | **GET** /data-sources/hcxs | List hcx data sources
...
*DataSourcesApi* | [**update_hcx**](docs/DataSourcesApi.md#update_hcx) | **PUT** /data-sources/hcxs/{id} | Update an hcx data source
...
*SettingsApi* | [**add_proxy**](docs/SettingsApi.md#add_proxy) | **POST** /settings/proxy-servers | Add new Proxy in the system
...
*SettingsApi* | [**delete_proxy**](docs/SettingsApi.md#delete_proxy) | **DELETE** /settings/proxy-servers/{id} | Delete an existing Proxy server
...
*SettingsApi* | [**disable_backup**](docs/SettingsApi.md#disable_backup) | **POST** /settings/backup/disable | Disable Backup
...
*SettingsApi* | [**enable_backup**](docs/SettingsApi.md#enable_backup) | **POST** /settings/backup/enable | Enable Backup
...
*SettingsApi* | [**get_connected_clients_to_proxy**](docs/SettingsApi.md#get_connected_clients_to_proxy) | **GET** /settings/proxy-servers/{id}/connected-clients | Get details of connected clients to Proxy Server
...
*SettingsApi* | [**get_proxies**](docs/SettingsApi.md#get_proxies) | **GET** /settings/proxy-servers | List of configured proxy servers
*SettingsApi* | [**get_proxy**](docs/SettingsApi.md#get_proxy) | **GET** /settings/proxy-servers/{id} | Get details of an existing Proxy Server
...
## Documentation For Models
 ...
 - [WebProxyConnectedClient](docs/WebProxyConnectedClient.md)
 - [WebProxyConnectedClientsList](docs/WebProxyConnectedClientsList.md)
