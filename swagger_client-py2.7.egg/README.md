...
*ApplicationsApi* | [**list_applications_details**](docs/ApplicationsApi.md#list_applications_details) | **GET** /groups/applications/fetch | Get application details in bulk
...
*DataSourcesApi* | [**get_all**](docs/DataSourcesApi.md#get_all) | **GET** /data-sources | List Data Sources added to vRNI
