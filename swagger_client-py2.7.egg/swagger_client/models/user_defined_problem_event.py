...
class UserDefinedProblemEvent(object):
    ...
    def __init__(self, entity_id=None, name=None, entity_type=None, anchor_entities=None, related_entities=None, message=None, event_tags=None, admin_state=None, archived=None, event_time_epoch_ms=None, event_type=None, recommendations=None, severity=None, total_count=None, refs_added_count=None, refs_deleted_count=None, subscriptions=None):
        """
