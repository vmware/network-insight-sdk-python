...
class EC2Instance(object):
    ...
    def __init__(self, entity_id=None, name=None, entity_type=None, ip_addresses=None, default_gateway=None, vnics=None, security_groups=None, source_firewall_rules=None, destination_firewall_rules=None, ip_sets=None, tag_keys=None, tag_key_values=None, vm_uuid=None, vpc=None, region=None, account=None):
        """
