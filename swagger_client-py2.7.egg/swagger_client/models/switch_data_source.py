...
class SwitchDataSource(object):
    ...
    def __init__(self, config_polling_interval_in_min=None, config_polling_interval_type=None, entity_id=None, entity_type=None, ip=None, fqdn=None, proxy_id=None, nickname=None, enabled=True, notes=None, certificate=None, sha_thumbprint=None, new_certificate=None, new_sha_thumbprint=None, credentials=None):
        """
