...
class ApplicationMessage(object):
    ...
    swagger_types = {
        'status': 'str',
        'deleted_at': 'int',
        'info': 'ApplicationMembersResponse'
    }
    ...
    def __init__(self, status=None, deleted_at=None, info=None):
        """
    ...
    def info(self):
        """
        Gets the info of this ApplicationMessage.

        :return: The info of this ApplicationMessage.
    ...
    def info(self, info):
        """
        Sets the info of this ApplicationMessage.

        :param info: The info of this ApplicationMessage.
