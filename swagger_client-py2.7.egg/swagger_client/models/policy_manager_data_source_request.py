...
class PolicyManagerDataSourceRequest(object):
    ...
    def __init__(self, ip=None, fqdn=None, proxy_id=None, nickname=None, enabled=True, notes=None, csp_refresh_token=None, vcenter_id=None, ipfix_enabled=False, web_proxy_id=None):
        """
