...
class SubscriptionResponse(object):
    ...
    def __init__(self, entity_id=None, active=None, event_name=None, is_problem=None, severity=None, search_criteria=None, generate_event_criteria=None, email_frequency=None, daily_at_utc=None, email_ids=None, snmp_trap_entity_ids=None):
        """
