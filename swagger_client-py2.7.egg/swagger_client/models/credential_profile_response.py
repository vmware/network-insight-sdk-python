...
class CredentialProfileResponse(object):
    ...
    def __init__(self, entity_id=None, name=None, connection_type=None, credential=None, snmp_credential=None, created_by=None, modified_by=None, creation_time=None, modified_time=None):
        """
