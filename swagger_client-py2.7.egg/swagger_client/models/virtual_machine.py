...
class VirtualMachine(object):
    ...
    def __init__(self, entity_id=None, name=None, entity_type=None, ip_addresses=None, default_gateway=None, vnics=None, security_groups=None, source_firewall_rules=None, destination_firewall_rules=None, ip_sets=None, tag_keys=None, tag_key_values=None, vm_uuid=None, manager_uuid=None, cluster=None, resource_pool=None, security_tags=None, layer2_networks=None, host=None, vlans=None, vendor_id=None, vcenter_manager=None, folders=None, datastores=None, datacenter=None, nsx_manager=None, source_inversion_rules=None, destination_inversion_rules=None, cpu_count=None, memory=None):
        """
