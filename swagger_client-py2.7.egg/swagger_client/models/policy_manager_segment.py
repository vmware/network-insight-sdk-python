...
class PolicyManagerSegment(object):
    ...
    def __init__(self, entity_id=None, name=None, entity_type=None, network_addresses=None, gateways=None, realized_entities=None, sddc_type=None, network_type=None, unique_id=None):
        """
