...
class DatabusSubscriber(object):
    ...
    def __init__(self, id=None, message_group=None, url=None):
        """
    ...
    def message_group(self):
        ...
        Message-group name for receiving the data from. Message group of a subscription cannot be changed after creation. Supported message groups - application, flows, problems, metrics, vms, hosts, nics, switchports
