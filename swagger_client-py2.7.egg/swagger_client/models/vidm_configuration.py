...
class VidmConfiguration(object):
    ...
    attribute_map = {
        ...
        'root_ca_certificate': 'rootCA_certificate',
        'client_id': 'client_id',
    ...
    def __init__(self, vidm_appliance=None, root_ca_certificate=None, client_id=None, client_secret=None, sha_thumbprint=None, enable=None):
        """
        VidmConfiguration - a model defined in Swagger
        """

        self._vidm_appliance = None
        self._root_ca_certificate = None
    ...
    def root_ca_certificate(self):
        """
        Gets the root_ca_certificate of this VidmConfiguration.
        Provide rootCA certificate to trust. Can be generated using /vidm/licence

        :return: The root_ca_certificate of this VidmConfiguration.
        :rtype: str
        """
        return self._root_ca_certificate

    @root_ca_certificate.setter
    def root_ca_certificate(self, root_ca_certificate):
        """
        Sets the root_ca_certificate of this VidmConfiguration.
        Provide rootCA certificate to trust. Can be generated using /vidm/licence

        :param root_ca_certificate: The root_ca_certificate of this VidmConfiguration.
        :type: str
        """

        self._root_ca_certificate = root_ca_certificate
