...
class MetricsApi(object):
    ...
    def fetch_bulk_metrics(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fetch_bulk_metrics(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param MetricsBulkFetchRequest body: (required)
        :return: MetricsBulkFetchResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.fetch_bulk_metrics_with_http_info(body, **kwargs)
        else:
            (data) = self.fetch_bulk_metrics_with_http_info(body, **kwargs)
            return data

    def fetch_bulk_metrics_with_http_info(self, body, **kwargs):
        """
        Get metric points for an array of entities in bulk
        This api is deprecated. Please use /metrics/fetch/v2. Get metric points for multiple entity ids and metric for a given time interval. All the entity ids should belong to the same entity type. Maximum number of metrics point per entity returned by API is configurable. Default is 300. In case the interval and time period combination have more than 300 metrics points, client should break the time period to multiple batches to get all the metrics points.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fetch_bulk_metrics_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method fetch_bulk_metrics" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `fetch_bulk_metrics`")
        ...
        return self.api_client.call_api('/metrics/fetch', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='MetricsBulkFetchResponse',
    ...
    def fetch_bulk_metrics_v2(self, body, **kwargs):
        """
        Get metric points for an array of entities in bulk
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fetch_bulk_metrics_v2(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param MetricsBulkFetchRequest body: (required)
        :return: MetricsBulkFetchResponseV2
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.fetch_bulk_metrics_v2_with_http_info(body, **kwargs)
        else:
            (data) = self.fetch_bulk_metrics_v2_with_http_info(body, **kwargs)
            return data

    def fetch_bulk_metrics_v2_with_http_info(self, body, **kwargs):
        """
        Get metric points for an array of entities in bulk
        Get metric points for multiple entity ids and metric for a given time interval. All the entity ids should belong to the same entity type. Maximum number of metrics point per entity returned by API is configurable. Default is 300. In case the interval and time period combination have more than 300 metrics points, client should break the time period to multiple batches to get all the metrics points.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fetch_bulk_metrics_v2_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method fetch_bulk_metrics_v2" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `fetch_bulk_metrics_v2`")
        ...
        return self.api_client.call_api('/metrics/fetch/v2', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='MetricsBulkFetchResponseV2',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_metrics_v2(self, entity_id, metric, interval, start, end, **kwargs):
        """
        Get metric points for an entity
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_metrics_v2(entity_id, metric, interval, start, end, callback=callback_function)
        ...
        :param int start: start time for query in epoch seconds (required)
        :param int end: end time for query in epoch seconds (required)
        :return: MetricResponseV2
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_metrics_v2_with_http_info(entity_id, metric, interval, start, end, **kwargs)
        else:
            (data) = self.get_metrics_v2_with_http_info(entity_id, metric, interval, start, end, **kwargs)
            return data

    def get_metrics_v2_with_http_info(self, entity_id, metric, interval, start, end, **kwargs):
        """
        Get metric points for an entity
        Get metric points for an entity for an entity id and metric for a given time interval. Maximum number of metrics point returned by API is 300. In case the interval and time period combination have more than 300 metrics points, client should break the time period to multiple batches to get all the metrics points. These metric points are the points inside the metric charts (CPU, network rate, etc.)
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_metrics_v2_with_http_info(entity_id, metric, interval, start, end, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_metrics_v2" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'entity_id' is set
        if ('entity_id' not in params) or (params['entity_id'] is None):
            raise ValueError("Missing the required parameter `entity_id` when calling `get_metrics_v2`")
        # verify the required parameter 'metric' is set
        if ('metric' not in params) or (params['metric'] is None):
            raise ValueError("Missing the required parameter `metric` when calling `get_metrics_v2`")
        # verify the required parameter 'interval' is set
        if ('interval' not in params) or (params['interval'] is None):
            raise ValueError("Missing the required parameter `interval` when calling `get_metrics_v2`")
        # verify the required parameter 'start' is set
        if ('start' not in params) or (params['start'] is None):
            raise ValueError("Missing the required parameter `start` when calling `get_metrics_v2`")
        # verify the required parameter 'end' is set
        if ('end' not in params) or (params['end'] is None):
            raise ValueError("Missing the required parameter `end` when calling `get_metrics_v2`")
        ...
        return self.api_client.call_api('/metrics/v2', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='MetricResponseV2',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
