...
class ApplicationsApi(object):
    ...
    def edit_application_tier(self, id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.edit_application_tier(id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.edit_application_tier_with_http_info(id, body, **kwargs)
        else:
            (data) = self.edit_application_tier_with_http_info(id, body, **kwargs)
            return data

    def edit_application_tier_with_http_info(self, id, body, **kwargs):
        """
        Edit tier in application
        Edit a tier of an application with specified membership criteria. The membership criteria id defined in terms of virtual machines or ip addresses/subnet. Please refer to API Guide on how to construct membership criteria.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.edit_application_tier_with_http_info(id, body, callback=callback_function)
