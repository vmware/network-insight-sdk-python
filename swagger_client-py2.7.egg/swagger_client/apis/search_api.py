...
class SearchApi(object):
    ...
    def search(self, **kwargs):
        """
        Search
        Using search QL API you can execute search by specifying search query directly as you specify on the UI. A successful search execution will return one of the following three things : 1. List of entity ids that matches the search criteria. 2. List of aggregations. 3. List of groups.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SearchQueryRequest body: Search Query Request
    ...
    def search_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/search/ql', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='SearchQueryResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
