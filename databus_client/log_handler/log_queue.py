...
class LogQueue:
    ...
    def __init__(self, num_of_worker_threads=2, message_group=None):
        ...
        self.file_scheduler = DatabusLogFileScheduler(message_group=message_group, file_threshold=200,
